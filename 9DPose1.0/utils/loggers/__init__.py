...
class Loggers():
    ...
    def __init__(self, save_dir=None, weights=None, opt=None, hyp=None, logger=None, include=LOGGERS):
        ...
        self.keys = ['train/box_loss', 'train/obj_loss', 'train/cls_loss', 'train/dir_loss', 'train/abc_loss','train/z_loss','train/pabc_loss',             
                     'metrics/precision', 'metrics/recall', 'metrics/mAP_0.5', 'metrics/mAP_0.5:0.95',           
                     'val/box_loss', 'val/obj_loss', 'val/cls_loss', 'val/dir_loss', 'val/abc_loss', 'val/z_loss','val/pabc_loss',           
                     'x/lr0', 'x/lr1', 'x/lr2']          
        for k in LOGGERS:
            setattr(self, k, None)                                
        self.csv = True                     
